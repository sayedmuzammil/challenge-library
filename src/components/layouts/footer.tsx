      ...
      <div className="max-w-6xl mx-auto px-4 text-center">
        ...
        <div>
          ...
          <div className="flex justify-center space-x-4">
            ...
            <a href="#" className="text-gray-400 hover:text-white">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-2.84v5.79a2.1 2.1 0 0 1-2.8 1.94 2.1 2.1 0 0 1 .7-4.07V2a4.83 4.83 0 0 0-1.92 9.19 2.1 2.1 0 0 1 0 3.61 4.83 4.83 0 0 0 1.92 9.19v-3.52a2.1 2.1 0 0 1-.7-4.07 2.1 2.1 0 0 1 2.8 1.94V22h2.84v-.31a4.83 4.83 0 0 1 3.77-4.25 4.83 4.83 0 0 1-.77-2.63c0-.38.04-.74.11-1.1a4.83 4.83 0 0 1 .77-2.63 4.83 4.83 0 0 1-.11-1.10c0-.38-.04-.74-.11-1.1z" />
              </svg>
            </a>
          </div>
        </div>
